    ...
    def search(self, query: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for filename in filenames:
                ...
                # Skip auto-generated entries: result-delivery artifacts and
                # auto-tool execution dumps — they match any query via substring
                # overlap but contain no user-meaningful memory (§Issue 2 fix,
                # provenance filter bypass P0-1).
