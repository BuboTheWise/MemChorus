...
def _is_placeholder_artifact(text: str) -> bool:
    ...
    NOTE: This function uses ONLY explicit regex patterns derived from observed
    placeholder formats. Heuristic fallbacks (length thresholds, structure
    checks) were removed because they produced false positives on legitimate
    short tool output like "pip install completed successfully with exit code 0".
    New placeholder variants should be added as new patterns here.
    """
