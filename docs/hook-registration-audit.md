...
**Date:** 2026-07-26
**Auditor:** executor agent (implementer)
...
Source: `~/hermes-agent/hermes_cli/plugins.py`
...
```
$ ~/.hermes/hermes-agent/venv/bin/hermes plugins list | grep memchorus
...
**Location:** `~/.hermes/hermes-agent/venv/lib/python3.11/site-packages/memchorus/hooks.py`
