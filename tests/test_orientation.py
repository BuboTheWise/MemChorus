...
- t_00112233: Hex Kanban ID detection + fallback chain priority order tests
...
class TestIsHermezProjectName(unittest.TestCase):
    ...
    def test_lowercase_hex_8_char_skipped(self):
        ...
        self.assertFalse(_is_hermez_project_name("t_00112233"))
    ...
    def test_short_hex_not_skipped(self):
        ...
        self.assertTrue(_is_hermez_project_name("t_00112233e5"))   # 10 chars
...
class TestResolveProjectHexSkip(unittest.TestCase):
    ...
    def test_hex_kanban_id_falls_to_workspace(self):
        ...
        try:
            result = _resolve_project("t_00112233")
...
class TestBuildOrientationQuery(unittest.TestCase):
    ...
    def test_hex_kanban_id_uses_workspace_not_raw_id(self):
        ...
        try:
            queries = _build_orientation_query(env_task="t_00112233")
            # The project should be "project" (workspace basename), NOT "t_00112233"
            for q in queries:
                self.assertNotIn("t_00112233", q["query"])
