...
class TestCalibrationEnginePipeline:
    ...
    def test_compute_adjustments_with_tracker(self):
        ...
        # Override aggregate_hit_rate_stats at instance level to avoid xdist singleton isolation issues.
        engine.aggregate_hit_rate_stats = lambda: (100, 50)
    ...
    def test_full_pipeline_integration(self):
        ...
        # Override aggregate_hit_rate_stats at instance level to avoid xdist singleton isolation issues.
        engine.aggregate_hit_rate_stats = lambda: (200, 150)
        saves, recalls = engine.aggregate_hit_rate_stats()
        assert saves == 200
        assert recalls == 150
